"""Scan intake logic. The HTTP layer declares routes; decisions live here.
The in-memory store lasts until persistence lands (Part 13) — the contract is
already final (Part 12.3)."""
...
class ScanService:
    ...
    def create(self, *, client_uuid: str, captured_at: str, mode: str, category: str,
        ...
        self._validate(coverage_asserted, panels, len(image_names))
    ...
    @staticmethod
    def _validate(coverage_asserted: bool, panels: list[str], n_images: int) -> None:
