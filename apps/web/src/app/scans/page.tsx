...
export default function ScansPage() {
  ...
  return <AppShell>
    <div className="page-head"><div><p className="eyebrow">Repository</p><h1>Inspections</h1><p>Search product evidence, evaluation status and compliance history.</p></div></div>
